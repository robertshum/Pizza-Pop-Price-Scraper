...
export const MSG_CREATE_PAGE_FAILURE ='Failed to create page from Puppeteer.  Check/rotate proxy or use localhost.';

export const MSG_COULD_NOT_FIND_SELECTORS = 'Could not find any selectors.  Puppeteer page exceeded timeout.';
